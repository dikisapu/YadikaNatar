        <div class="row">
          <div class="col s12 m9">
            <h3 class="orange-text">pelapor</h3>
          </div>  
	...
	<?php 
		$no=1;
		$query = mysqli_query($koneksi,"SELECT * FROM pelapor ORDER BY nik ASC");
          ...
          <div class="modal-content">
			...
			<?php 
				if(isset($_POST['Update'])){
					$update=mysqli_query($koneksi,"UPDATE pelapor SET nik='".$_POST['nik']."',nama='".$_POST['nama']."',username='".$_POST['username']."',telp='".$_POST['telp']."' WHERE nik='".$r['nik']."' ");
					if($update){
          ...
          <div class="modal-content">
			...
			<?php 
				if(isset($_POST['simpan'])){
					...
					$query=mysqli_query($koneksi,"INSERT INTO pelapor VALUES ('".$_POST['nik']."','".$_POST['nama']."','".$_POST['username']."','".$password."','".$_POST['telp']."')");
					if($query){
