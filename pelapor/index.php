<?php 
 ...
 ?>
  ...
  <html>
    <head>
    	<title>Aplikasi Pengaduan Yadika Natar</title>
    ...
    <body style="background:url(../img/bglex.jpg); background-size: cover;">
          ...
          <ul id="slide-out" class="sidenav sidenav-fixed">
              <li>
                  <div class="user-view">
                      ...
                      <a href="#name"><span class="blue-text name"><?php echo ucwords($_SESSION['data']['nama_petugas']); ?></span></a>|web by  <a href='https://smkyadikanatar.sch.id/' title='Smk Yadika Natar' target='_blank'>Smk Yadika Natar </a>
