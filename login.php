...
<h3 style="text-align: center;" class="orange-text">Login san!</h3>
<br><p>Autorithy san</p>
...
<?php 
	if(isset($_POST['login'])){
		...
		$sql = mysqli_query($koneksi,"SELECT * FROM pelapor WHERE username='$username' AND password='$password' ");
