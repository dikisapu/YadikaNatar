	...
	<?php 
		$no=1;
		$query = mysqli_query($koneksi,"SELECT * FROM pengaduan INNER JOIN pelapor ON pengaduan.nik=pelapor.nik WHERE pengaduan.status='proses' ORDER BY pengaduan.id_pengaduan DESC");
